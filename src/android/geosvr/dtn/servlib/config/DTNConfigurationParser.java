 ...
 *    
 */
package android.geosvr.dtn.servlib.config;
...
import android.geosvr.dtn.servlib.config.DiscoveriesSetting.address_family_t;
...
import android.geosvr.dtn.servlib.config.StorageSetting.storage_type_t;
...
public class DTNConfigurationParser {
	...
	private static void process_routes_config(Element config_element, DTNConfiguration config, SharedPreferences myPrefs) throws InvalidDTNConfigurationException
	{
		...
		System.out.println(router_type.getValue());
...
//		}
		...
		Attr Queue_type = config_element.getAttributeNode("queuing");
//		String Queue_type=myPrefs.getString("Queue_Type", null);
		config.routes_setting().setQueuing_policy(Queue_type.getValue());
