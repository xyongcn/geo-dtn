...
import android.geosvr.dtn.systemlib.util.Set;
...
//		this.destLongitude_ = destLongitude;
	...
	/**
	 * bundleTransimitted消息能否取消其他link上的bundle的发送
	 */
	private boolean cancelOtherLinkTransmit=true;
	...
	/**
	 * 检测是否可以取消其他link上的bundle发送
	 * @return
	 */
	public boolean canCancelOtherLinkTransmit()
	{
		return cancelOtherLinkTransmit;
	}
	
	/**
	 * 设置能够取消其他link上的bundle传输
	 * @param canCancel
	 */
